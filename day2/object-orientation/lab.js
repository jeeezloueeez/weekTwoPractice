...
//Code here
favoriteThings.car = `Rolls-Royce`;
favoriteThings[`show`] = `Is It Cake?`;
...
let {make} = carDetails
let {model: carModel, year: carYear} = carDetails
...
function ingredients(obj){
  let newArr = []
  let {carb: carbohydrates, fat: fatty, protein: meat} = obj
  newArr.push(carbohydrates, fatty, meat)
  return newArr
}
let food = {
  carb: `pasta`,
...
let jimmy = new Cat(`Jimmy`, 40, `orange`)
console.log(jimmy)
//////////////////////////// PROBLEM 13 ////////////////////////////
/*
...
let luis = new Wizard(`Luis`, 27, `teleport`)
luis.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let phone1 = new Phone(`Apple`, `iPhone`, `1TB`, `black`, 1299)
let phone2 = new Phone(`Android`, `G70X`, `1TB`, `white`, 1199)
let phone3 = new Phone(`Apple`, `iPhone`, `500 GB`, `gold`, 899)
/* 
...
//Code Here
let myFirstVehicle = new Vehicle(6, `white`, 106000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, `red`, 100000, `Ducatti`, true)
/*
...
//Code Here
let myFirstBoat = new Boat(20, `pearl`, 20000, `The Dev`, `Yacht`, false)
